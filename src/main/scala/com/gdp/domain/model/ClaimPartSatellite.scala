...
case class ClaimPartSatellite(bk: String, cim_src_sys_id: String, cim_oe_id: String, cim_invalid_ts: Timestamp,
                              ...
                              salvage_amount: String) extends Satellite {

}

object ClaimPartSatellite {
